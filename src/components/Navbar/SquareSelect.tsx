...
function SquareSelect() {
    const { currentKey, savedSquareKeys: savedSqaureKeys, newSquareKey, changeSquare, removeCurrentSquareKey } = useContext(SquareDataContext)
    ...
    return <div className="square-select-container">
